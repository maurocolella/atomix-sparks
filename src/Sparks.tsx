...
function Fatline({ curve, width, color, speed } : { curve: any, width: number, color: string, speed: number }) {
...
export default function Sparks({ mouse, count, colors, radius = 10 } : { mouse: any, count: number, colors: string[], radius?: number }) {
  const lines = useMemo(
    () =>
